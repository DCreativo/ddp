...
// require_once '../php/Terrestres.php';
// $terrestres = new Terrestres;

// $id_terrestres = isset($_POST['id_terrestres'])? limpiarCadena($_POST['id_terrestres']):"";

// $terrestres->insertar($nombre,$apellidos,$telefono,$email,$fecha_ida,$fecha_vuelta,$cant_adult,$cant_ninos,$cant_inf,$transporte);
...
//ENVIAR AL CORREO
$enviarA = 'terrestres@ddperu.pe'; //REEMPLAZAR CON TU CORREO ELECTRÓNICO
$asunto = $nombre . ' ';
$asunto .= $apellidos . ' ';
$asunto .= 'solicita cotización de pasajes terrestres';
