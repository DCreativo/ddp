...
<section class="container-fluid px-0 py-4">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 text-center">
				<div class="h3 py-2 text-e11 mb-3"><b>Pasajes Terrestres</b></div>
			</div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 p-0">
        <form class="text-white p-4 bg-e11 rounded-left" id="terrestres" novalidate>
  ...
  <div class="col-sm-9 py-1">
    <select class="form-control" name="transporte" id="transporte" required>
     ...
     <option value="Ittsa">Ittsa</option>
     <option value="Movil-Buss">Movil Buss</option>
     <option value="Civa">Civa</option>
     <option value="Linea">Linea</option>
     <option value="America">América</option>
     <option value="Allin-Buss">Allin Bus</option>
...
<div class="col-sm-12">
  ...
  <!-- mensaje exito -->
  <div class="alert alert-success alert-dismissible fade show d-none mb-0 mt-2" role="alert" id="exitoTerrestre">Cotización enviado con éxito
  ...
  <!-- mensaje de error -->
  <div class="alert alert-danger alert-dismissible fade show d-none mb-0 mt-2" role="alert" id="errorTerrestre">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
...
<!-- /FORMULARIO -->
  ...
  <div class="col-sm-6 p-0">
    <img src="img/terrestres.jpg" class="img-fluid">
  </div>
...
<script src="scripts/terrestres.js"></script>
